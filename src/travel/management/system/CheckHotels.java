...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run() {
        try {
            int i;
            String[] cap = new String[]{"JW Mariott Hotel", "Madarin Oriental Hotel", "The Imperial Hotel", "Hyatt Regency Hotel", "The Oberoi Grands Hotel", "Amanbagh Palace Hotel", "Hilton Garden Hotel", "Six Senses Fort Hotel", "Lake Palace Hotel", "Vedic Villas Hotel Grand"};
    ...
    CheckHotels(){
        ...
        JLabel head = new JLabel("CHECK OUT OUR HOTELS");
        head.setBounds(120, 5, 300, 40);
